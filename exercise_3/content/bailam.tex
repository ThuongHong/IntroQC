...
\textbf{Vẽ mạch cho cả hai hàm:}
\begin{figure}[H]
    \centering

    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/cau6_1.png}
        \caption{Mạch Deutsch-Jozsa cho $f_1$}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/cau6_2.png}
        \caption{Mạch Deutsch-Jozsa cho $f_2$}
    \end{minipage}

\end{figure}


\textbf{Kết quả thực nghiệm:} (\textit{kết quả trong notebook})
\begin{itemize}
